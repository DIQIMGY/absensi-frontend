      ...
      <AnimatePresence>
        {lb && (
          <motion.div
            ...
            style={{ background: 'rgba(0,0,0,0.96)', backdropFilter: 'blur(16px)', touchAction: 'none' }}
            onClick={() => setLb(null)}
            onTouchEnd={() => setLb(null)}>

            <button onClick={() => setLb(null)}
              className="absolute top-4 right-4 w-10 h-10 rounded-full flex items-center justify-center text-white/40 hover:text-white transition-colors z-10"
